"""
XmR Process Behavior Chart -- Enterprise Form Submissions (Weekly, Sliding 20-Week Baseline)
...
df = pd.read_csv(DATA_DIR / "enterprise_form_submissions.csv", parse_dates=["WEEK_START"])
...
# Title block
fig.text(0.05, 0.97, "ENTERPRISE FORM SUBMISSIONS",
...
ax_x.set_ylabel("Weekly Enterprise Form Submissions", fontsize=9.5, color=TEXT_2, labelpad=8)
