"""
XmR Process Behavior Chart -- Single Song Rev (Daily, Sliding 90-Day Baseline)
...
df = pd.read_csv(DATA_DIR / "single_song_rev.csv", parse_dates=["DATE"])
...
fig.text(
    0.06, 0.935,
    "Single Song Rev (Daily)  \u2022  Sliding 90-Day Baseline  \u2022  Wheeler Signal Rules",
    fontsize=9, color=TEXT_SECONDARY, style="italic",
)

ax_x.set_ylabel("Single Song Rev", fontsize=9.5, color=TEXT_SECONDARY, labelpad=8)
...
out_path = CHART_DIR / "single_song_rev.png"
