"""
XmR Process Behavior Chart -- Enterprise Form Submissions (Daily, Sliding 90-Day Baseline)
...
df = pd.read_csv(DATA_DIR / "enterprise_form_submissions.csv", parse_dates=["DATE"])
...
fig.text(
    0.06, 0.935,
    "Enterprise Form Submissions (Daily)  \u2022  Sliding 90-Day Baseline  \u2022  Wheeler Signal Rules",
    fontsize=9, color=TEXT_SECONDARY, style="italic",
)

ax_x.set_ylabel("Enterprise Form Submissions", fontsize=9.5, color=TEXT_SECONDARY, labelpad=8)
...
out_path = CHART_DIR / "enterprise_form_submissions.png"
