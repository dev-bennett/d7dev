"""
XmR Process Behavior Chart -- ARR (Daily, Sliding 90-Day Baseline)
...
df = pd.read_csv(DATA_DIR / "arr.csv", parse_dates=["DATE"])
...
fig.text(
    0.06, 0.935,
    "ARR (Daily)  \u2022  Sliding 90-Day Baseline  \u2022  Wheeler Signal Rules",
    fontsize=9, color=TEXT_SECONDARY, style="italic",
)

ax_x.set_ylabel("ARR", fontsize=9.5, color=TEXT_SECONDARY, labelpad=8)
