-- XmR Process Behavior Chart -- Organic Search Subscriptions (Sliding 90-Day Baseline)
-- Purpose: Wheeler XmR with adaptive process limits using a trailing 90-day window
-- Author: d7admin
-- Date: 2026-04-06
...
,source_data AS (
    SELECT
        k.date
        ,NVL(k.organic_search_subscriptions, 0) AS value
