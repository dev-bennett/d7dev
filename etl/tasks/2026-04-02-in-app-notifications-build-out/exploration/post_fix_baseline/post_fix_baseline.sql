-- Post-fix baseline: corrected notification performance from reporting layer
-- Source: soundstripe_prod.marketing.fct_notification_deliveries (rebuilt after Stitch fix)
-- Purpose: Establish corrected KPIs/benchmarks for LookML dashboard validation
-- Author: d7admin
-- Date: 2026-04-02


--qa  Data shape and time range
SELECT
